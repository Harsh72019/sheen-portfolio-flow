...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative z-10 py-6 sm:py-8 border-t border-white/10 bg-[#060810] text-slate-400">
      <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="flex items-center gap-2.5">
            <div className="flex items-center gap-1.5">
              <a
                ...
                className="p-2 rounded-lg bg-white/[0.04] hover:bg-white/[0.08] text-slate-300 hover:text-white border border-white/10 transition-colors"
                aria-label="GitHub"
                title="GitHub"
              >
            ...
            <button
              onClick={scrollToTop}
              className="flex items-center gap-1 px-3 py-2 rounded-lg bg-white/[0.04] hover:bg-white/[0.08] text-slate-300 hover:text-white border border-white/10 transition-colors text-xs font-mono"
            >
              <span>Top</span>
        ...
        {/* Bottom Copyright */}
        <div className="mt-4 sm:mt-5 pt-3 sm:pt-4 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-1.5 text-[10px] sm:text-[11px] text-slate-500 font-mono text-center sm:text-left">
          <span>© {new Date().getFullYear()} Harsh Bali. All rights reserved.</span>
          <span className="text-slate-600 sm:text-slate-500">Engineered with React & TypeScript</span>
        </div>
